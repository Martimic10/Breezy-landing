        ...
        >
          ...
          <div className="relative z-10">
            ...
            <div className="mt-10 flex flex-col items-center justify-center gap-4 sm:flex-row">
              ...
              <a
                href="#"
                className="rounded-2xl border border-white/60 bg-white/60 px-6 py-3.5 text-sm font-semibold text-black shadow-sm backdrop-blur-md transition-all hover:border-white/80 hover:bg-white/80"
              >
                Join the Beta
              </a>
            </div>
